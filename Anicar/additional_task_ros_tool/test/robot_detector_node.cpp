...
// messages). The actual functionality should be tested in the library that implements it. Any test acts like a node and
// can receive and send messages to your nodes/nodelets to test their behaviour You can even control time by setting
// "use_sim_time" in the .test-file and advertising the /clock topic. Keep in mind that:
...
// TEST(additional_task_ros_tool, RobotDetectorTest){
//    //your tests go here
//}

int main(int argc, char** argv) {
    testing::InitGoogleTest(&argc, argv);
    ros::init(argc, argv, "robot_detector_test");
